        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form action="/users/update" method="post">
                    ...
                    Password: <input value="${userPassword}" name="password" type="text"/>
                    <input type="hidden" name="id" value="${id}" /><br>
                    <input type="hidden" name="oldUserName" value="${userName}" /><br>
                    <input type="hidden" name="oldEmail" value="${Email}" /><br>
                    <input type="hidden" name="oldPassword" value="${userPassword}" /><br>
