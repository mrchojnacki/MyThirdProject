            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/users/addUserForm.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Add New User</a>
                    </div>
                    <table>
                        <tr>
                            <th>ID</th>
                        ...
                        <c:forEach items="${userList}" var="User">
                            <tr>
                                ...
                                <td><p>
                                    ...
                                    <a href="/users/findtoupdate?userId=${User.id}">Edit</a>
                                    <a href="">Show</a>
                                </p></td>
                            </tr>
                        </c:forEach>
